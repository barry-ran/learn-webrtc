...
VideoRenderer::VideoRenderer(webrtc::VideoTrackInterface* track_to_render, QLabel* label)
...
void VideoRenderer::OnFrame(const webrtc::VideoFrame &frame)
{
    ...
    if (label_) {
        ...
        label_->setPixmap(QPixmap::fromImage(image.scaled(label_->width(), label_->height())));
    }
}
